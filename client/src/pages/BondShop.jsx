...
const BOND_META = {
  mother:     { label: 'For Mother',     desc: "Timeless pieces that honour the woman who gave you everything", icon: '🌸', img: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=1400&auto=format&fit=crop&q=85' },
  father:     { label: 'For Father',     desc: "Strong, classic jewellery for the man who built your world",   icon: '🌟', img: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=1400&auto=format&fit=crop&q=85' },
  wife:       { label: 'For Wife',       desc: "Express your forever love with something she'll treasure",      icon: '💍', img: 'https://images.unsplash.com/photo-1469371670807-013ccf25f16a?w=1400&auto=format&fit=crop&q=85' },
  ...
  boyfriend:  { label: 'For Boyfriend',  desc: "Thoughtful pieces for the man who matters most",               icon: '💎', img: 'https://images.unsplash.com/photo-1500048993953-d23a436266cf?w=1400&auto=format&fit=crop&q=85' },
  sister:     { label: 'For Sister',     desc: "Celebrate the bond that nothing can break",                    icon: '✨', img: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=1400&auto=format&fit=crop&q=85' },
  brother:    { label: 'For Brother',    desc: "Classic and bold jewellery for your favourite person",         icon: '🏅', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1400&auto=format&fit=crop&q=85' },
  son:        { label: 'For Son',        desc: "Mark life's milestones with something he'll keep forever",     icon: '⭐', img: 'https://images.unsplash.com/photo-1519456264917-42d0aa2e0625?w=1400&auto=format&fit=crop&q=85' },
  daughter:   { label: 'For Daughter',   desc: "Beautiful pieces for the light of your life",                  icon: '🌺', img: 'https://images.unsplash.com/photo-1518621845945-eb03bd89a58a?w=1400&auto=format&fit=crop&q=85' },
  ...
  all:        { label: 'Shop by Bond',   desc: "Gifts that go beyond jewellery — they carry your feeling",    icon: '💛', img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=1400&auto=format&fit=crop&q=85' },
}
  ...
  return (
    <div style={{ padding: 'clamp(24px,4vw,48px) 5%', maxWidth: 1200, margin: '0 auto' }}>
      ...
      {loading && page === 1 ? (
        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 24 }} className="product-grid">
            {products.map(p => (
              <GridProductCard
                key={p.id} product={p}
